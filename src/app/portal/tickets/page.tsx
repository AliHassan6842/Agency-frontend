    ...
    <div className="flex-1 space-y-8 h-full flex flex-col">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">Submit a request, report a bug, or ask for help.</p>
        </div>
        <CreateTicketDialog />
      </div>
      ...
      {tickets.length === 0 ? (
        <div className="flex flex-col items-center justify-center flex-1 rounded-xl border border-dashed p-12 text-center bg-card">
          ...
          <p className="text-sm text-muted-foreground mt-1 mb-4 max-w-sm">
            You don&apos;t have any open support requests. Need help? Create a ticket to get started.
          </p>
        </div>
      ) : (
